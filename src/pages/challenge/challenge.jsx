        ...
        <div className="cont-principal">
            ...
            <div className="menu-emerge">
                <div className="menu">
                    ...
                    <ul>
                        <div onClick={handleFeature} className="menu-show">
                        <li>Features</li>
                            { features ? 
                            ...
                            <div className={`${features ? 'menuShowActive': 'menuShowDisalable'}`}>
                        ...
                        <div onClick={handleCompany} className="menu-show">
                            <li>Company</li>
                            { company ? 
                            <svg width="10" height="6" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" stroke-width="1.5" fill="none" d="m1 5 4-4 4 4"/></svg>
                            :<svg width="10" height="6" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" stroke-width="1.5" fill="none" d="m1 1 4 4 4-4"/></svg>
                            ...
                            <div className={`${company ? 'menuShowActive': 'menuShowDisalable'}`}>   
                                <ul className="contentUl"><h3>History</h3></ul>
                                <ul className="contentUl"><h3>Our Team</h3></ul>
                                <ul className="contentUl"><h3>Blog</h3></ul>
                            </div>
                        <li>careers</li>
                        <li>about</li>
                    </ul>
                ...
                <header>
                    ...
                    <div className="navigation">
                        <div onClick={handleFeature} className="menuShowDesktop">
                        <li>Features</li>
                            { features ? 
                            <svg width="10" height="6" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" stroke-width="1.5" fill="none" d="m1 5 4-4 4 4"/></svg>
                            :<svg width="10" height="6" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" stroke-width="1.5" fill="none" d="m1 1 4 4 4-4"/></svg>
                            }
                            <div className={`${features ? 'menuShowActiveDesktop': 'menuShowDisalableDesktop'}`}>
                                <ul className="contentUl">
                                    <svg width="14" height="16" xmlns="http://www.w3.org/2000/svg"><path d="M14 3v12a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1h1V1a1 1 0 1 1 2 0v1h2V1a1 1 0 1 1 2 0v1h2V1a1 1 0 0 1 2 0v1h1a1 1 0 0 1 1 1Zm-2 3H2v1h10V6Zm0 3H2v1h10V9Zm0 3H2v1h10v-1Z" fill="#726CEE"/></svg>
                                    <h3>Todo List</h3>
                                </ul>
                        ...
                        <div onClick={handleCompany} className="menuShowDesktop">
                            <li>Company</li>
                            { company ? 
                            <svg width="10" height="6" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" stroke-width="1.5" fill="none" d="m1 5 4-4 4 4"/></svg>
                            :<svg width="10" height="6" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" stroke-width="1.5" fill="none" d="m1 1 4 4 4-4"/></svg>
                            }
                            <div className={`${company ? 'menuShowActiveDesktop': 'menuShowDisalableDesktop'}`}>   
                            <ul className="contentUl"><h3>History</h3></ul>
                            <ul className="contentUl"><h3>Our Team</h3></ul>
                            <ul className="contentUl"><h3>Blog</h3></ul>
                            </div>
...
{/* ////////////////////////// */}
            ...
            <article className="article">
                ...
                <p>Get your team in sync, no matter your location. Streamline processes, create
